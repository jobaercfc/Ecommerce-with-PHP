                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped table-bordered toggle-arrow-tiny tablet breakpoint footable-loaded" data-page-size="15">
                                <thead>
                                <tr>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT p.id as pid, p.*, imagePaths.*,productCategory.*,wishlists.* FROM ((products as p INNER JOIN imagePaths on (p.imagePathsID = imagePaths.id)) INNER JOIN productCategory on (p.categoryID = productCategory.id)) INNER JOIN wishlists on (p.id = wishlists.productID) where wishlists.userID = '$uid'";
                                                ...
                                                <tr class="footable-even" style="">
                                                    ...
                                                    <td class="text-right footable-visible footable-last-column">
                                                        <div class="btn-group">
                                                            ...
                                                            <button class="btn-reddit btn btn-xs" id="removefromwishlist" pid='.$pid.'>Delete</button>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ';
